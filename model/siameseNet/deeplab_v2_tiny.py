...
class SiameseNet(nn.Module):
    def __init__(self,distance_flag='l2'):
        super(SiameseNet, self).__init__()
        self.CNN = deeplab_V2(distance_flag)
    ...
    def init_parameters_from_deeplab(self,pretrain_vgg16_1024):
        ...
        init.kaiming_uniform(self.CNN.embedding_layer[0].weight.data,mode='fan_in')
        init.constant(self.CNN.embedding_layer[0].bias.data,0)
        '''''''''
